...
namespace DotNet20BridgeNet4x.ILRepack
{
     ...
     */
        ...
        /// </summary>
        public FileInfo ILRepackExeFile { get; set; }
        /// <summary>
        /// Gets or sets a keyfile to sign the output assembly.(no keyfile set null)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the target assembly version.(if null use primaryAssembly assembly version)
        /// </summary>
